...
class Controller {
    ...
    async controlMenu() {
        try {
            ...
            await _model__WEBPACK_IMPORTED_MODULE_0__["default"].loadMenu();
            const menuCats = _model__WEBPACK_IMPORTED_MODULE_0__["default"].state.menuCategories;
            _view__WEBPACK_IMPORTED_MODULE_1__["default"].renderCatBar(menuCats);
            _view__WEBPACK_IMPORTED_MODULE_1__["default"].render(_model__WEBPACK_IMPORTED_MODULE_0__["default"].state);
        } catch(err) {
            _view__WEBPACK_IMPORTED_MODULE_1__["default"].renderError();
        }
    }

    init() {
        _view__WEBPACK_IMPORTED_MODULE_1__["default"].addHandlerMenu(this.controlMenu);
    }
}
...
/******/ })()
;
//# sourceMappingURL=bundlec276f27f4e09cfecd9f9.js.map